 ...
 *
 * File : checkyours.php
 * Let you check one of your own requests.
 */
...
$request = $DB->get_record('enrol_stafftraining_enroldata', array('id' => $requestid, 'userid' => $USER->id), '*', MUST_EXIST);
$group = $DB->get_record('groups', array('id' => $request->groupid));
$course = $DB->get_record('course', array('id' => $group->courseid));

$moodlefilename = '/blocks/stafftraining/checkyours.php';
...
$yoururl = new moodle_url('/blocks/stafftraining/your.php');
$PAGE->navbar->add(get_string('pluginname', 'block_stafftraining'), $browseurl);
$PAGE->navbar->add(get_string('yourrequests', 'block_stafftraining'), $yoururl);
...
$askerdata = $DB->get_record('enrol_stafftraining_userdata', array('userid' => $USER->id));
...
block_stafftraining_formline(get_string('chiefname', 'enrol_stafftraining'), $askerdate->chiefname);
echo '<br>';
